...
app.layout = html.Div(
    [
        html.Div(dcc.Graph(id='forecast-graph', figure=figure), style={'border': '3px solid black', 'float': 'left', 'width': 'auto', 'margin': '5px'}),
    ...
    ], style={'display': 'inline-block', 'padding': '15px', 'width': 'auto', 'margin-left': '0px', 'margin-right': '0px'}
)
